...
export const GOVERNANCE_SESSION_FIELDS = Object.freeze(["instructionsAck", "lastCard", "lastDelivery", "specCheckedAt", "linkedExecution", "activeByRoot", "specDeliveries", "questionsAvoided", "digestHash", "promotionOffered"]);
