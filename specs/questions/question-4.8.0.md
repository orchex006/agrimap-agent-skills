...
| --- | --- | --- | --- | --- |
| Q-4.8.0-01 | เปิด `governance.decisionMemory` ให้ config เดิมที่เขียน `false` ไว้ | decided | 1 — เปิดครั้งเดียวพร้อม marker | ต่ำ |
| Q-4.8.0-02 | ข้อความ §2 แบบสั้นใน core `AGENTS.md` (ข้อความใหม่ในงานย้ายไฟล์) | decided | 1 — ตาราง 2 แถว + 1 ประโยค | ต่ำ |
| Q-4.8.0-03 | ค่า default ของ promotion card | decided | 1 — non-blocking default "ไม่ต้อง" | ต่ำ |
