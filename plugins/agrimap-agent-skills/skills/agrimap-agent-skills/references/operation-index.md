...
| `agm-release` | `release` | Index AgriMap projects, prepare patch versions, publish Inhouse pipelines, and promote Production with explicit confirmation | `product-write` | default `light`; allowed `light`, `standard`, `regulated` |
